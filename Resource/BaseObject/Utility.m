...
+ (NSString *) url:(enum enumUrl)eUrl
{
    ...
    switch (eUrl)
    {
        ...
        case urlPushSyncUpdateTimeSynced:
            ...
            break;
        case urlMasterGet:
            url = @"/Android/AND_JUMMUM_OM/JMSMasterGet.php";
            break;
        case urlLogInInsert:
        ...
        case urlLogInUserAccountInsert:
            ...
            break;
        case urlWriteLog:
            url = @"/Android/AND_JUMMUM_OM/JMSWriteLog.php";
            break;
        case urlMenuInsert:
        ...
        case urlReceiptSummaryGetList:
            url = @"/Android/AND_JUMMUM_OM/JMSReceiptSummaryGetList.php";
            break;
        ...
        case urlUserAccountValidate:
            url = @"/Android/AND_JUMMUM_OM/JMSUserAccountValidate.php";
            break;
        ...
        case urlTermsOfService:
            url = @"/Android/AND_JUMMUM_OM/HtmlTermsOfService.php";
            break;
        case urlUserAccountForgotPasswordInsert:
            url = @"/Android/AND_JUMMUM_OM/JMSUserAccountForgotPasswordInsert.php";
            break;
        ...
        case urlReceiptMaxModifiedDateGetList:
            url = @"/Android/AND_JUMMUM_OM/JMSReceiptMaxModifiedDateGetList.php";
            break;
        case urlReceiptWithModifiedDateGet:
            url = @"/JMM/JUMMUM3/JMMReceiptWithModifiedDateGet.php";
            break;
        case urlReceiptGet:
            url = @"/Android/AND_JUMMUM_OM/JMSReceiptGet.php";
            break;
        ...
        case urlDisputeReasonGetList:
            url = @"/Android/AND_JUMMUM_OM/JMSDisputeReasonGetList.php";
            break;
        case urlDisputeInsert:
            url = @"/Android/AND_JUMMUM_OM/JMSDisputeInsert.php";
            break;
        case urlDisputeCancelInsert:
            url = @"/Android/AND_JUMMUM_OM/JMSDisputeCancelInsert.php";
            break;
        ...
        case urlCredentialsDbGet:
            url = @"/Android/AND_JUMMUM_OM/JMSCredentialsDbGet.php";
            break;
        case urlCredentialsValidate:
            url = @"/Android/AND_JUMMUM_OM/JMSCredentialsValidate.php";
            break;
        case urlDeviceInsert:
            url = @"/Android/AND_JUMMUM_OM/JMSDeviceInsert.php";
            break;
        case urlJummumReceiptGetList:
            url = @"/Android/AND_JUMMUM_OM/JMSJummumReceiptGetList.php";
            break;
        case urlJummumReceiptUpdate:
            url = @"/Android/AND_JUMMUM_OM/JMSJummumReceiptUpdate.php";
            break;
        case urlJummumReceiptSendToKitchen:
            url = @"/Android/AND_JUMMUM_OM/JMSJummumReceiptSendToKitchen.php";
            break;
        case urlBranchGet:
            url = @"/Android/AND_JUMMUM_OM/JMSBranchGet.php";
            break;
        case urlOpeningTimeTextGet:
            url = @"/Android/AND_JUMMUM_OM/JMSOpeningTimeTextGet.php";
            break;
        case urlSettingUpdate:
            url = @"/Android/AND_JUMMUM_OM/JMSSettingUpdate.php";
            break;
        case urlSettingGet:
            url = @"/Android/AND_JUMMUM_OM/JMSSettingGet.php";
            break;
        case urlContactUs:
            url = @"/Android/AND_JUMMUM_OM/HtmlContactUs.php";
            break;
        default:
            break;
    }
